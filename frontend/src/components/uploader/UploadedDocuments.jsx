...
import { getAllUploadedDocuments } from '@/api/uploader-api';
...
const UploadedDocuments = () => {
    const { data, isPending, isError, error } = useQuery({
        ...
        queryFn: getAllUploadedDocuments
    });
    ...
    if (docs.length === 0) {
        return <div className='text-center text-gray-500'>No uploaded documents found</div>;
    }
